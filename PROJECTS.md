...
| Reinforcement Learning | **[Penalty Shootout (RoboCup)](https://github.com/francis802/Penalty_Shoot_FCP)** | A penalty-shootout agent for the RoboCup 3D Soccer Simulation League, built on the FC Portugal codebase: a PPO-trained striker that learns to approach and score, and a reactive goalkeeper that dives to defend. |
...
| Responsible AI | **[AI-Society](https://github.com/francis802/AI-Society)** | An algorithmic-fairness audit inspired by the Rotterdam welfare-fraud scandal, using SHAP, LIME and counterfactual-fairness tests to expose gender and racial bias in a high-stakes decision model, plus hands-on workshops on data-centric AI. |
